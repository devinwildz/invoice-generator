...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-blue-50 via-amber-50 to-slate-100">
      <div className="mx-auto flex min-h-screen w-full max-w-6xl flex-col justify-between px-6 py-6">
        ...
        <main className="grid gap-12 py-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-600">
              A modern invoicing workspace with live preview, client management,
              and instant PDF export. Everything you need to bill confidently.
            </p>
            ...
            <div className="flex flex-wrap mt-5 justify-between gap-6 text-sm text-slate-500">
              <div>
            ...
            <div className="surface rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <div className="rounded-xl bg-amber-50 px-4 py-2 text-right">
                  ...
                  <p className="text-xl font-semibold text-amber-700">$3,240</p>
                </div>
              </div>
              ...
              <div className="mt-6 flex items-center justify-between border-t border-slate-100 pt-4 text-sm text-slate-500">
                ...
                <span>Sent to: Brightside Studio</span>
              </div>
            </div>
          </div>
        </main>
